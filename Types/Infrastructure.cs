...
//		public static bool Read(string section, string key, bool @default, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			return Vi.Statics.Profile.Read(section, key, System.String.Empty, fileName, onWarning).ToBool(@default);
//		}
...
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
//		public static int Read(string section, string key, int @default, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
...
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
//		public static long Read(string section, string key, long @default, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			return Vi.Statics.Profile.Read(section, key, System.String.Empty, fileName, onWarning).ToLong(@default);
//		}
...
//		{
//			return Vi.Statics.Profile.Read(section, key, System.String.Empty, fileName, Vi.Statics.Profile.OnWarning).ToBool(@default);
//		}
...
//		{
//			return Vi.Statics.Profile.Read(section, key, System.String.Empty, fileName, Vi.Statics.Profile.OnWarning).ToLong(@default);
//		}
...
//			try
//			{
//				var values = Vi.Statics.Profile.Read(section, key, new int[] { @default.X, @default.Y }, fileName);
...
//			try
//			{
//				var values = Vi.Statics.Profile.Read(section, key, new int[] { @default.Width, @default.Height }, fileName);
...
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, int value, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			Vi.Statics.Profile.Write<int>(section, key, value, fileName, onWarning);
//		}
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, long value, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			Vi.Statics.Profile.Write<long>(section, key, value, fileName, onWarning);
//		}
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, bool value, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			Vi.Statics.Profile.Write<bool>(section, key, value, fileName, onWarning);
//		}
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, decimal value, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			Vi.Statics.Profile.Write<decimal>(section, key, value, fileName, onWarning);
//		}
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, string value, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
//			// 'Comments' are not allowed when the value is a string.
//			Vi.Statics.Profile.Write<string>(section, key, value, fileName, onWarning);
//		}
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, int[] values, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//		{
...
//		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//		/// <param name="onWarning">The callback used to manage exceptions.</param>
//		public static void Write(string section, string key, bool[] values, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//        {
//            Vi.Statics.Profile.Write<string>(section, key, System.String.Join(";", values), fileName, onWarning);
//        }
...
//        /// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
//        /// <param name="onWarning">The callback used to manage exceptions.</param>
//        public static void Write(string section, string key, string[] values, string fileName, Vi.Statics.Profile.WarningDelegate onWarning)
//        {
//            Vi.Statics.Profile.Write<string>(section, key, System.String.Join(";", values), fileName, onWarning);
//        }
...
//		{
//			Vi.Statics.Profile.Write<int>(section, key, value, fileName, Vi.Statics.Profile.OnWarning);
//		}
...
//		{
//			Vi.Statics.Profile.Write<long>(section, key, value, fileName, Vi.Statics.Profile.OnWarning);
//		}
...
//		{
//			Vi.Statics.Profile.Write<bool>(section, key, value, fileName, Vi.Statics.Profile.OnWarning);
//		}
...
//		{
//			// 'Comments' are not allowed when the value is a string.
//			Vi.Statics.Profile.Write<string>(section, key, value, fileName, Vi.Statics.Profile.OnWarning);
//		}
...
//		{
//			Vi.Statics.Profile.Write<string>(section, key, System.String.Join(";", values), fileName, Vi.Statics.Profile.OnWarning);
//		}
...
//		{
//			Vi.Statics.Profile.Write(section, key, new int[] { location.X, location.Y }, fileName);
//		}
...
//		{
//			Vi.Statics.Profile.Write(section, key, new int[] { size.Width, size.Height }, fileName);
//		}
