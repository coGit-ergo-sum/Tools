...
namespace Vi.Types
{
        ...
        private static readonly Dictionary<int, string> _hResultDescriptions = new Dictionary<int, string>
    {
        ...
        public static string GetDescription(int hresult)
        {
            ...
            // ToDo '_hResultDescriptions' not used!!!
            return $"Severity: {severity.Description} ({severity.Value}), Facility: {facility.Description} (0x{facility.Value:X}), Code: 0x{GetCode(hresult):X}";
        }
