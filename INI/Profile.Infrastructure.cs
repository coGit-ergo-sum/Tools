...
namespace Vi.Tools
{
	// Collezione di metodi (di infrastruttura) in 'overload' con quelli fondamentali definiti nell'altro file di quetsa 'partial class'
	public static partial class Profile
	{
		...
		public static bool Read(string section, string key, bool @default, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			return Vi.Tools.Profile.Read(section, key, System.String.Empty, fileName, onWarning).ToBool(@default);
		}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
		public static int Read(string section, string key, int @default, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			return Vi.Tools.Profile.Read(section, key, System.String.Empty, fileName, onWarning).ToInt(@default);
		}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
		public static long Read(string section, string key, long @default, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			return Vi.Tools.Profile.Read(section, key, System.String.Empty, fileName, onWarning).ToLong(@default);
		}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void Write(string section, string key, int value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			Vi.Tools.Profile.Write<int>(section, key, value, fileName, onWarning);
		}
		...
		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void Write(string section, string key, long value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			Vi.Tools.Profile.Write<long>(section, key, value, fileName, onWarning);
		}
		...
		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void Write(string section, string key, bool value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			Vi.Tools.Profile.Write<bool>(section, key, value, fileName, onWarning);
		}
		...
		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void Write(string section, string key, string value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			// 'Comments' are not allowed when the value is a string.
			Vi.Tools.Profile.Write<string>(section, key, value, fileName, onWarning);
		}
