...
namespace Vi.Tools
{
	...
	public static partial class Profile
	{
		...
		{
			if (Vi.Tools.Profile.Warning != null) { Vi.Tools.Profile.Warning(parameter, message, fileName); }
		}
		...
		//private static string[] Sections(string[] @default, int bufferSize, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		private static string[] Sections(int bufferSize, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			...
			else if (length > 0 && length < lengthMax)
			{
				...
				string[] sections = Vi.Tools.Profile.ToArray(value);

				return sections;
			}
			else
			{
				return Vi.Tools.Profile.Sections(bufferSize * 2, fileName, onWarning);
			}
		...
		public static string[] Sections(string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			int bufferSize = 256;
			////////string[] @default = null;
			return Vi.Tools.Profile.Sections(bufferSize, fileName, onWarning);
		}
		#endregion
		...
		internal static string[] Keys(string section, int bufferSize, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			var value = Vi.Tools.Profile.Read(section, null, null, 1024, fileName, onWarning);
			string[] keys = Vi.Tools.Profile.ToArray(value);
			return keys;
		}
		...
		public static string[] Keys(string section, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			int bufferSize = 256;
			return Vi.Tools.Profile.Keys(section, bufferSize, fileName, onWarning);
		}
		...
		private static string Read(string section, string key, string @default, int bufferSize, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			try
			{
				var SUCCESS = -2147024896;
				...
				{
					return Vi.Tools.Profile.Read(section, key, @default, bufferSize * 2, fileName, onWarning);
				}
			}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
		public static string Read(string section, string key, string @default, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			var parametersOk =
				Vi.Tools.Profile.CheckSection(section, fileName, onWarning) &&
				Vi.Tools.Profile.CheckKey(key, fileName, onWarning);
			int bufferSize = 64;
			return (parametersOk) ? Vi.Tools.Profile.Read(section, key, @default, bufferSize, fileName, onWarning) : @default;
		}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>The data read from the INI file. '@default' if something  whent wrong. (This method should't raise any exception).</returns>
		public static System.DateTime Read(string section, string key, System.DateTime @default, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			return Vi.Tools.Profile.Read(section, key, System.String.Empty, fileName, onWarning)
				.Split(';')[0]
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		private static void Write<T>(string section, string key, T value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			var parametersOk =
				Vi.Tools.Profile.CheckSection(section, fileName, onWarning) &&
				Vi.Tools.Profile.CheckKey(key, fileName, onWarning) &&
				Vi.Tools.Profile.CheckFileName(fileName, onWarning);
			...
			if (parametersOk)
			{
				...
				Vi.Tools.Profile.DeleteKey(section, key, fileName, onWarning);
				// ==================================================================================== //

				var text = value.ToString();

				// Checks if value is null and removes chr(0) from the string.
				Vi.Tools.Profile.CheckValue(ref text, fileName, onWarning);
		...
		/// <param name="fileName">The full path of the INI file where write data. If null the callback 'onWarning' will be called.</param>
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void Write(string section, string key, System.DateTime value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			...
			Vi.Tools.Profile.Write<string>(section, key, text, fileName, onWarning);
		}
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void DeleteKey(string section, string key, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			try
			{
				var parametersOk =
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void DeleteKeys(string section, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			try
			{
				Vi.Tools.Profile.DeleteSection(section, fileName, onWarning);
				Vi.Tools.Profile.Write(section, "Fake", "To bin", fileName, onWarning);
				Vi.Tools.Profile.DeleteKey(section, "Fake", fileName, onWarning);
			}
			catch (System.Exception se)
			{
				onWarning("DeleteKey", se.Message, fileName);
		...
		/// <param name="fileName">The full path of the INI file.</param>
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void DeleteSection(string section, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			try
			{
				var parametersOk =
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		public static void DeleteAll(string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			try
			{
				var filenameOK = Vi.Tools.Profile.CheckFileName(fileName, onWarning);
				if (filenameOK)
				{
		...
		internal static bool CheckSection(string section, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			if (section == null)
			{
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>True if 'section' passes the checks. False otherwise and the callback 'onWarning' is called also.</returns>
		internal static bool CheckKey(string key, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			if (key == null)
			{
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>True if 'section' passes the checks. False otherwise and the callback 'onWarning' is called also.</returns>
		internal static bool CheckValue(ref string value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>True if 'section' passes the checks. False otherwise and the callback 'onWarning' is called also.</returns>
		internal static bool CheckValues(int[] value, string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			if (value == null)
			{
				onWarning("value", "Parameter 'value' can't be null. (Use DeleteKey instead).", fileName);
		...
		/// <param name="onWarning">The callback used to manage exceptions.</param>
		/// <returns>True if 'section' passes the checks. False otherwise and the callback 'onWarning' is called also.</returns>
		internal static bool CheckFileName(string fileName, Vi.Tools.Profile.WarningDelegate onWarning)
		{
			if (fileName == null)
			{
