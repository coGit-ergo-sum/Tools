...
namespace Vi.Tools
{
	...
	public class Profilo
	{
		...
		{
			Vi.Tools.Profile.CheckFileName(fileName, this.OnWarning);
		...
		{
			return Vi.Tools.Profile.Sections(this.FileName, this.OnWarning);
		}
		#endregion
		...
		{
			return Vi.Tools.Profile.Keys(section, this.FileName, this.OnWarning);
		}
		...
		{
			return Vi.Tools.Profile.Read(section, key, @default, this.FileName, this.OnWarning);
		}
		...
		*/
		...
		{
			Vi.Tools.Profile.Write(section, key, values, this.FileName, this.OnWarning);
		}
		...
		*/
		...
		{
			Vi.Tools.Profile.DeleteKey(section, key, this.FileName, this.OnWarning);
		}
		...
		{
			Vi.Tools.Profile.DeleteKeys(section, this.FileName, this.OnWarning);
		}
		...
		{
			Vi.Tools.Profile.DeleteSection(section, this.FileName, this.OnWarning);
		}
		...
		{
			Vi.Tools.Profile.DeleteAll(this.FileName, this.OnWarning);
		}
