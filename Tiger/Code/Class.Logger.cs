...
namespace Vi
{
    ...
    public static class Logger  
    {
        ...
        public delegate void LogNDelegate(int indentation, Vi.Logger.Levels level, string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?");
        ...
        /// <param name="caller">The caller from where this method was called.</param>
        /// <param name="file">The file from where this method was called.</param>
        public delegate void LogEDelegate(System.Exception se, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?");
        ...
        public class FakeLog : Vi.ILog
        {
            ...
            public void Debug(string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
            ...
            /// <param name="caller">The name of the caller from which the log comes.</param>
            /// <param name="file">The name of the file from where this method is called.</param>
            public void Info(string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
            ...
            /// <param name="caller">The name of the caller from which the log comes.</param>
            /// <param name="file">The name of the file from where this method is called.</param>
            public void Warn(string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
            ...
            /// <param name="caller">The name of the caller from which the log comes.</param>
            /// <param name="file">The name of the file from where this method is called.</param>
            public void Error(Exception se, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
            ...
            /// <param name="caller">The name of the caller from which the log comes.</param>
            /// <param name="file">The name of the file from where this method is called.</param>
            public void Error(Vi.Types.Error ve, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
            ...
            /// <param name="caller">The name of the caller from which the log comes.</param>
            /// <param name="file">The name of the file from where this method is called.</param>
            public void Exception(System.Exception se, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?") { }
        } 
        #endregion
        ...
        /// <param name="caller">The name of the caller from which the log comes.</param>
        /// <param name="file">The name of the file from where this method is called.</param>
        public delegate void FormatDelegate(string text, int line, string caller, string file);
        ...
        public class FormatClass
        {
            ...
            public FormatClass(FormatDelegate callBack, int line, string caller, string file)
            {
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Write(Levels level, string message,  [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Write(message, level.ToString(), line, caller, file);    
        }
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Write(string level, string message,  [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            ...
            {
                case "":
                    Logger.Warn("Level could not be null or empty", line, caller, file);
                    Logger.Warn(message, line, caller, file);
                    break;

                case "DEBUG":
                    Logger.Debug(message, line, caller, file);
                    break;

                case "FATAL":
                    //Logger.Fatal(message, line, caller, file);
                    Logger.Write(Vi.Logger.Levels.ERROR, $" 'level': {level} shouldn't be called.", line, caller, file);
                    Logger.Write(Vi.Logger.Levels.ERROR, message, line, caller, file);
                    break;

                case "INFO":
                    Logger.Info(message, line, caller, file);
                    break;
                ...
                case "ERROR":
                    // Logger.Error(new Vi.Types.Error(message), line, caller, file);
                    Logger.Error(message, line, caller, file);
                    break;

                case "EXCEPTION":
                    Logger.Exception(new System.Exception(message), line, caller, file);
                    break;

                default:
                    Logger.Write(Vi.Logger.Levels.ERROR, $"Value unexpected for 'level': {level}", line, caller, file);
                    Logger.Write(Vi.Logger.Levels.ERROR, message, line, caller, file);
                    break;
            }
        ...
        // // [DebuggerStepThrough]
        public static FormatClass Write(Levels level, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Action<string, int, string, string> write = (_text, _line, _caller, _file) =>
            {
                Logger.Write(level, line, caller, file);
            };
            return new FormatClass(new FormatDelegate(write), line, caller, file);
        }
        ...
        /// <param name="caller">The name of the caller from which the log comes.</param>
        /// <param name="file">The name of the file from where this method is called.</param>
        public static void Write(Vi.Types.Error ve, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            //if (!Logger.SkipDebug)
            //{
            if (Vi.Logger._Implementation != null)
            {
                //Vi.Logger._Implementation.Error(ve, line, caller, file);
                Vi.Logger.OnLogN?.Invoke(indentation: 0, Levels.ERROR, ve.Message, line, caller, file);
            }
            //}
        }
        ...
        /// <param name="caller">The caller from where this method was called.</param>
        /// <param name="file">The file from where this method was called.</param>
        public static void Write(System.Exception se, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            //if (!Logger.SkipDebug)
            //{
            if (Vi.Logger._Implementation != null)
        ...
        /// <param name="line">The Line of the file where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Debug(int indentation, string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            if (!Logger.SkipDebug)
            {
                if (Vi.Logger._Implementation != null)
                {
                    Vi.Logger._Implementation.Debug(message, line, caller, file);
                    Vi.Logger.OnLogN?.Invoke(indentation, Levels.DEBUG, message, line, caller, file);
                }
            }
        }
        ...
        /// <param name="caller">The caller from where this method was called.</param>
        /// <param name="file">The file from where this method was called.</param>
        public static void Debug(string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Debug(0, message, line, caller, file);
        }
        ...
        /// <returns>An instance of 'FormatClass' with the method 'Format' used to compose the message to log like the 'String.Format'</returns>
        // // [DebuggerStepThrough]
        public static FormatClass Debug([CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            return new FormatClass(Logger.Debug, line, caller, file);
        }
        #endregion
        ...
        // // [DebuggerStepThrough]
        public static void Info(string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Info(0, message, line, caller, file);
        }
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Info(int indentation, string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger._Implementation.Info(text, line, caller, file);
            Vi.Logger.OnLogN?.Invoke(indentation, Levels.INFO, text, line, caller, file);
        }
        ...
        // // [DebuggerStepThrough]
        public static FormatClass Info([CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            return new FormatClass(Logger.Info, line, caller, file);
        }
        #endregion
        ...
        /// <param name="line">The Line of the file where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Warn(string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Warn(0, text, line, caller, file);
        }
        ...
        /// <param name="line">The Line of the file where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Warn(int indentation, string text, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger._Implementation.Warn(text, line, caller, file);
            Vi.Logger.OnLogN?.Invoke(indentation, Levels.WARN, text, line, caller, file);
        }
        ...
        /// <returns>An instance of 'FormatClass' with the method 'Format' used to compose the text to log like the 'String.Format'</returns>
        // // [DebuggerStepThrough]
        public static FormatClass Warn([CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            return new FormatClass(Vi.Logger.Warn, line, caller, file);
        }
        #endregion
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Error(int indentation, Vi.Types.Error ve, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger._Implementation.Error(ve, line, caller, file);
            Vi.Logger.OnLogN?.Invoke(indentation, Levels.ERROR, ve.Message, line, caller, file);
        }
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Error(string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Error(indentation: 0, new Types.Error(message), line, caller, file);
        }
        ...
        /// <param name="file">The name of the file from where this method is called.</param>
        // // [DebuggerStepThrough]
        public static void Error(int indentation, string message, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Error(indentation, new Types.Error(message), line, caller, file);
        }
        ...
        /// <param name="file">The file from where this method was called.</param>
        // // [DebuggerStepThrough]
        public static void Exception(System.Exception se, [CallerLineNumber] int line = 0, [CallerMemberName] System.String caller = "?", [CallerFilePath] System.String file = "?")
        {
            Vi.Logger.Exception(indentation: 0, se, line, caller, file);
        }
